...
const quests = [
  ...
  {
    id: "quest-quiz-zk-cryptography",
    title: "ZK Cryptography Quiz",
    description: "Test your knowledge of zero-knowledge cryptography.",
    type: "quiz",
    xpReward: 250,
    badgeId: 39,
    cooldownMin: 1440,
  ...
  {
    id: "quest-quiz-abstract-gas-tokenomics",
    title: "Abstract Gas & Tokenomics Quiz",
    description: "How well do you understand gas refunds and paymasters?",
    type: "quiz",
    xpReward: 150,
    badgeId: 40,
    cooldownMin: 1440,
  ...
  {
    id: "quest-quiz-defi-on-abstract",
    title: "DeFi on Abstract Quiz",
    description: "Test your knowledge on AMMs, yield farming, and liquidity.",
    type: "quiz",
    xpReward: 200,
    badgeId: 38,
    cooldownMin: 1440,
  ...
  {
    id: "quest-quiz-advanced-account-abstraction",
    title: "Advanced Account Abstraction Quiz",
    description: "Deep dive into bundlers, EntryPoint, and session keys.",
    type: "quiz",
    xpReward: 250,
    badgeId: 41,
    cooldownMin: 1440,
  ...
  {
    id: "quest-quiz-rollup-history-zksync",
    title: "Rollup History & zkSync Quiz",
    description: "Learn about Vitalik's rollup roadmap and Hyperchains.",
    type: "quiz",
    xpReward: 200,
    badgeId: 37,
    cooldownMin: 1440,
